function validateForm(){
 var day = Number(document.getElementById("date").value);
 var fullYear = new Date(day).getFullYear();
 var month = new Date(day).getMonth();
 var century =fullYear.toString().split(0,2)
 var year=fullYear.toString().split(2,4)
